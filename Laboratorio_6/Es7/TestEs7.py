...
try:
    ...
    while len(s)>0:
        ...
        if(contatore == 0):
            ...
            commandstring="lavorastringa="+nomeFile+"."+coppiaInputRisultato[0][1:-1]
            command="stu=timelimit(3,lavorastringa."+nomeMetodo+")"
        elif(contatore == 1):
            ...
            commandstring="lavorastringa="+nomeFile+"."+coppiaInputRisultato[0][1:-1].split(",")[0]
            command="stu=timelimit(3,lavorastringa."+nomeMetodo+",["+ coppiaInputRisultato[0][1:-1].split(",")[1]+"])"
        elif(contatore == 2):
            ...
            commandstring="lavorastringa="+nomeFile+"."+coppiaInputRisultato[0][1:-1].split(",")[0]
            command="stu=timelimit(3,lavorastringa."+nomeMetodo+",["+ coppiaInputRisultato[0][1:-1].split(",")[1]+","+coppiaInputRisultato[0][1:-1].split(",")[2]+"])"
        elif(contatore == 7):
            print(metodiStudente[7].split(".")[1]+coppiaInputRisultato[0])
            nomeFile = metodiStudente[7].split(".")[0]
            nomeMetodo = metodiStudente[7].split(".")[1]
            commandstring="lavorastringa="+nomeFile+"."+coppiaInputRisultato[0][1:-1]
            command="stu=timelimit(3,lavorastringa."+nomeMetodo+")"
        elif(contatore == 8):
            print(metodiStudente[8].split(".")[1]+coppiaInputRisultato[0])
            nomeFile = metodiStudente[8].split(".")[0]
            nomeMetodo = metodiStudente[8].split(".")[1]
            commandstring="lavorastringa="+nomeFile+"."+coppiaInputRisultato[0][1:-1].split(",")[0]
            command="stu=timelimit(3,lavorastringa."+nomeMetodo+",["+ coppiaInputRisultato[0][1:-1].split(",")[1]+"])"
        elif(contatore == 9):
            print(metodiStudente[9].split(".")[1]+coppiaInputRisultato[0])
