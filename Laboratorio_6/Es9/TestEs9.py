...
try:
    ...
    while len(s)>0:
        ...
        print("========================")
        print("self = "+coppiaInputRisultato[0][1:])
        if contatore == 0:
            #print("t = copiaDebole(self)")
            print(metodoStu.split(".")[1]+"(self,copiaDebole(self))")               
            print("========================")
            exec("doc="+coppiaInputRisultato[1]) #FL RISULTATO GIUSTO
            print("Il risultato giusto: ",doc,"\n***********")
            command_a="a = "+metodoStu.split(".")[0]+"."+coppiaInputRisultato[0][11:-1].split("),")[0]+")"
            command_b="b = "+metodoStu.split(".")[0]+"."+coppiaInputRisultato[0][11:-1].split("),")[1]+")"
            command_c="c = "+metodoStu.split(".")[0]+"."+coppiaInputRisultato[0][11:-1].split("),")[2]
            command_self="self = "+metodoStu.split(".")[0]+"."+"Triangolo(a,b,c)"
            command_t = "t = self.copiaDebole()"
            #print(metodoStu)
            #print(command_a)
            #print(command_b)
            #print(command_c)
            #print(command_self)
            #print(command_t)
            command="stu=timelimit(3,"+ "self.uguali"+",[t]"+")"
            exec(command_a)
            exec(command_b)
            exec(command_c)
            exec(command_self)
            ...
            #print("t = copiaProfonda(self)")
            print(metodoStu.split(".")[1]+"(self,copiaProfonda(self))")               
            print("========================")
            exec("doc="+coppiaInputRisultato[1]) #FL RISULTATO GIUSTO
            print("Il risultato giusto: ",doc,"\n***********")
            command_a="a = "+metodoStu.split(".")[0]+"."+coppiaInputRisultato[0][11:-1].split("),")[0]+")"
            ...
            command_c="c = "+metodoStu.split(".")[0]+"."+coppiaInputRisultato[0][11:-1].split("),")[2]
            command_self="self = "+metodoStu.split(".")[0]+"."+"Triangolo(a,b,c)"
            command_t = "t = self.copiaProfonda()"
            #print(metodoStu)
            #print(command_a)
            #print(command_b)
            #print(command_c)
