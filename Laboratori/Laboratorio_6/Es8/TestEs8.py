...
try:
    ...
    while len(s)>0:
        ...
        if(contatore == 0):
            ...
            commandstring="lavoralista="+nomeFile+"."+coppiaInputRisultato[0][1:-1]
            command="stu=timelimit(3,lavoralista."+nomeMetodo+")"
        elif(contatore == 1):
            ...
            commandstring="lavoralista="+nomeFile+"."+coppiaInputRisultato[0][1:-1].split("),")[0]+")"
            command="stu=timelimit(3,lavoralista."+nomeMetodo+",["+ coppiaInputRisultato[0][1:-1].split("),")[1]+"])"
        elif(contatore == 2):
        ...
        if(contatore==0 and stu is not None):
